	...
	public function add() {
		if ($this->request->is('post')) {
			...
			if ($this->ContactList->save($this->request->data)) {
				$this->Session->setFlash(__('The contact list has been saved'));
				$this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('The contact list could not be saved. Please, try again.'));
			}
		}
	}
 ...
 */
	public function delete($id = null) {
		...
		if ($this->ContactList->delete()) {
			$this->Session->setFlash(__('Contact list deleted'));
			$this->redirect(array('action'=>'index'));
		}
		$this->Session->setFlash(__('Contact list was not deleted'));
		$this->redirect(array('action' => 'index'));
	}
}
