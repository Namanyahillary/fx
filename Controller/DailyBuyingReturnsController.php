	...
	public function add() {
		if ($this->request->is('post')) {
			...
			if ($this->DailyBuyingReturn->save($this->request->data)) {
				$this->Session->setFlash(__('The daily buying return has been saved'));
				$this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('The daily buying return could not be saved. Please, try again.'));
			}
		}
 ...
 */
	public function delete($id = null) {
		...
		if ($this->DailyBuyingReturn->delete()) {
			$this->Session->setFlash(__('Daily buying return deleted'));
			$this->redirect(array('action'=>'index'));
		}
		$this->Session->setFlash(__('Daily buying return was not deleted'));
		$this->redirect(array('action' => 'index'));
	}
}
