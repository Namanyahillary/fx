 ...
 */
	public function index() {
		...
		if(	isset($_REQUEST['date_from']) &&
			...
			$this->Session->setFlash(__('Date range required.'));
		}
 ...
 */
	public function edit($id = null) {
		...
		if ($this->request->is('post') || $this->request->is('put')) {
			if ($this->DailyReturn->save($this->request->data)) {
				$this->Session->setFlash(__('The daily return has been saved'));
				$this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('The daily return could not be saved. Please, try again.'));
			}
		} else {
			$options = array('conditions' => array('DailyReturn.' . $this->DailyReturn->primaryKey => $id));
 ...
 */
	public function delete($id = null) {
		...
		if ($this->DailyReturn->delete()) {
			$this->Session->setFlash(__('Daily return deleted'));
			$this->redirect(array('action'=>'index'));
		}
		$this->Session->setFlash(__('Daily return was not deleted'));
		$this->redirect(array('action' => 'index'));
	}
}
