	...
	public function add() {
		if ($this->request->is('post')) {
			...
			if ($this->DailySellingReturn->save($this->request->data)) {
				$this->Session->setFlash(__('The daily selling return has been saved'));
				$this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('The daily selling return could not be saved. Please, try again.'));
			}
		}
 ...
 */
	public function delete($id = null) {
		...
		if ($this->DailySellingReturn->delete()) {
			$this->Session->setFlash(__('Daily selling return deleted'));
			$this->redirect(array('action'=>'index'));
		}
		$this->Session->setFlash(__('Daily selling return was not deleted'));
		$this->redirect(array('action' => 'index'));
	}
}
