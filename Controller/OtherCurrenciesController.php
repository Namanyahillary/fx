	...
	public function add() {
		if ($this->request->is('post')) {
			...
			if ($this->OtherCurrency->exists($OtherCurrency_ID)) {
				$this->Session->setFlash(__('Currency ID Exists Already.'));
			...
			if ($this->OtherCurrency->save($this->request->data)) {
				$this->Session->setFlash(__('The other currency has been saved'));
				$this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('The other currency could not be saved. Please, try again.'));
			}
		}
	}
 ...
 */
	public function delete($id = null) {
		...
		if ($this->OtherCurrency->delete()) {
			$this->Session->setFlash(__('Other currency deleted'));
			$this->redirect(array('action' => 'index'));
		}
		$this->Session->setFlash(__('Other currency was not deleted'));
		$this->redirect(array('action' => 'index'));
	}
}
