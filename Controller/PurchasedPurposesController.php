	...
	public function add() {
		if ($this->request->is('post')) {
			...
			if ($this->PurchasedPurpose->save($this->request->data)) {
				$this->Session->setFlash(__('The purchased purpose has been saved'));
				$this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('The purchased purpose could not be saved. Please, try again.'));
			}
		}
	}
 ...
 */
	public function delete($id = null) {
		...
		if ($this->PurchasedPurpose->delete()) {
			$this->Session->setFlash(__('Purchased purpose deleted'));
			$this->redirect(array('action'=>'index'));
		}
		$this->Session->setFlash(__('Purchased purpose was not deleted'));
		$this->redirect(array('action' => 'index'));
	}
}
