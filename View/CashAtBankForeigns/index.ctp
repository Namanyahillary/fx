...
<div class="cashAtBankForeigns index well">
	<h2><?php echo __('Foreign Cash At Bank'); ?></h2>
	...
	<tr>
		<td><?php echo h($cashAtBankForeign['CashAtBankForeign']['amount']); ?>&nbsp;</td>
		<td><?php echo h($cashAtBankForeign['CashAtBankForeign']['bank_name']); ?>&nbsp;</td>
		<td>
...
<div class="actions">
	<h3><?php echo __(''); ?></h3>
	<ul>
		<li><?php echo $this->Html->link(__('Add Foreign Cash At Bank'), array('action' => 'add')); ?></li>
	</ul>
</div>
