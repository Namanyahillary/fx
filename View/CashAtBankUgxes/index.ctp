...
<div class="cashAtBankUgxes index well">
	<h2><?php echo __('Ugx Cash At Bank'); ?></h2>
	...
	<tr>
		<td><?php echo h($cashAtBankUgx['CashAtBankUgx']['bank_name']); ?>&nbsp;</td>
		<td><?php echo h($cashAtBankUgx['CashAtBankUgx']['amount']);$total_amount+=$cashAtBankUgx['CashAtBankUgx']['amount']; ?>&nbsp;</td>
...
<div class="actions">
	<h3><?php echo __(''); ?></h3>
	<ul>
		<li><?php echo $this->Html->link(__('Add Ugx Cash At Bank'), array('action' => 'add')); ?></li>
	</ul>
</div>
