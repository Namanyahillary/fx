...
<?php
	...
	if(	isset($_REQUEST['receipt_number']) && !empty($_REQUEST['receipt_number']) &&
		...
		@mysql_query(sprintf("INSERT into purchased_receipts(id,fox_id,customer_name,amount,purchased_purpose_id,rate,amount_ugx,currency_id,date,nationality,address,passport_number,status,user_id,name,orig_amount,orig_rate,other_name,other_currency_id) 
